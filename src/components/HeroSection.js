...
const useCountAnimation = (targetNumber, shouldCount = true, duration = 2000) => {
...
const HeroSection = () => {
  ...
  // Stats data
  const stats = [
    { number: 250, label: 'Unique Menus', suffix: '+', delay: 200 },
    { number: 105, label: 'Corporate Clients', suffix: '+', delay: 400 },
    { number: 66, label: 'City Branch', suffix: '+', delay: 600 },
    { number: 90, label: 'Customer Rate', suffix: '%', delay: 800 }
  ];
    ...
    <section className="hero-section position-relative overflow-hidden">
      ...
      <div className="hero-content text-center py-5 py-lg-0">
        <div className="container h-100 d-flex flex-column justify-content-center">
          ...
          <p className={`lead mb-4 fs-4 hero-subtitle ${textVisible ? 'fade-in' : ''}`}>
          ...
          > Get Started <i className="fab fa-whatsapp"></i></button>
